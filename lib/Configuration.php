...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://gael-preprod.france-education-international.fr/api';
    ...
    {
        $report  = 'PHP SDK (Fei\Gael) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://gael-preprod.france-education-international.fr/api/",
                "description" => "Serveur de préprod",
            ],
            [
                "url" => "https://gael.france-education-international.fr/api/",
