...
/**
 * ResponseToken Class Doc Comment
 *
 * @category Class
 * @description réponse de Login
 * @package  Fei\Gael
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResponseToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseToken';
     ...
     * Sets username
     *
     * @param string|null $username identifiant
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token token à utiliser dans les autres requêtes pour être authentifié
     *
     * @return self
     */
