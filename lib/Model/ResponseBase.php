...
class ResponseBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets success
     *
     * @param bool|null $success Indicateur de succès de la requête
     *
     * @return self
     */
     ...
     * Sets msg
     *
     * @param string|null $msg Message indiquant la cause de l'erreur si GAEL la connait.
     *
     * @return self
     */
