...
/**
 * Nationalite Class Doc Comment
 *
 * @category Class
 * @description GAEL contient un référentiel des nationalités et attend uniquement des nationalités comprise dans cette liste.
 * @package  Fei\Gael
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class Nationalite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Nationalite';
     ...
     * Sets id
     *
     * @param int $id la clef primaire de la nationalité dans GAEL
     *
     * @return self
     */
     ...
     * Sets libelle
     *
     * @param string $libelle le libellée de la nationalité dans GAEL
     *
     * @return self
     */
